...
class ByzantineAttackSimulator:
    ...
    def poison_gradients(
        ...
        """Applying the configured attack to a single client's gradients."""
    ...
    def _adaptive(
        ...
        for g, h_mean in zip(grads, mean_honest):
            ...
            # Projecting along mean direction but flip
...
class AttackOrchestrator:
    ...
    def run_round(
        ...
        """
        Applying Byzantine attacks to a subset of clients.
        """
